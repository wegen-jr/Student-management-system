...
export default function EnrollmentBar() {
  return (
    <div className='flex items-center justify-center bg-white text-black p-3 w-full h-20 gap-48'>
            ...
            <Link to={'/admin/enrollments/sections'}>
                <div className='bg-blue-900 text-white font-bold w-40 p-2 h-10 rounded-2xl hover:bg-blue-800 transition transform hover:scale-105'>
                    <p className='text-center'>Enroll Section</p> 
                </div>
            </Link>
    </div>
  )
